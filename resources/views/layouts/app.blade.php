...
<head>
    ...
    <style>
        body {
            ...
            /* Definindo o fundo do site como preto */
            color: white;
        ...
        .icons {
            margin-left: auto;
            /* Isso empurrará os ícones para a direita */
        }
        ...
        .icons ul li {
            ...
            /* Isso fará com que os ícones fiquem lado a lado */
            margin-left: 20px;
            /* Adiciona um espaço entre os ícones */
        }
    ...
    <section class="info">
        ...
        <div class="infoCard">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
                <path
                    d="M12 2C8.14 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.14-7-7-7zM12 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
            </svg>
            ...
            <div class="footerRow">
                ...
                <section class="footerInfos">
                    ...
                    <div class="infosPayment">
                        ...
                        <div>
                            <img src="./assets/image/Métodos de pagamentos aceitos.webp"
