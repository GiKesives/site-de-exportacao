...
<form action="{{ route('produtos.update', $produto->id) }}" method="POST" class="mt-3">
    @csrf
    @method('PUT')

    <h1 class="mt-5 text-center">Editar Produto</h1>
    <!-- Texto centralizado com margem inferior -->
    ...
    <form action="{{ route('produtos.update', $produto->id) }}" method="POST" class="mt-3">
        ...
        <div class="form-group">
            ...
            <input type="text" id="preco" name="preco" value="{{ $produto->preco }}" class="form-control">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="imagem" name="imagem" value="{{ $produto->imagem }}" class="form-control">
        </div>
